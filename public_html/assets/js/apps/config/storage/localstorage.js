define(["app", "localstorage"], function(SondageManager) {
    SondageManager.module("Entities", function(Entities, SondageManager, Backbone, Marionette, $, _) {
        var findStorageKey = function(entity) {
            ...
            throw new Error("Impossible De Déterminer La Clé De Stockage.");
        };
    ...
    return SondageManager.Entities.configureStorage;
});
