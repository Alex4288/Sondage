define(["app"
      , "tpl!apps/sondages_contenu/common/templates/form.tpl"
   , "backbone.syphon"
   , "entities/type_sondage_id"], function(SondageManager, formTpl) {
        SondageManager.module("SondagesContenuApp.Common.Views", function(Views, SondageManager, Backbone, Marionette, $, _) {
    ...
    return SondageManager.SondagesContenuApp.Common.Views;
});
